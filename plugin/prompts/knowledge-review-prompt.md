...
检查事实来源、覆盖范围、粒度、父级、重复概念、关系方向、栏目适用性。逐条输出问题的 nodeId、规则、依据、建议修改和影响的引用。四条共享粒度规则为 MULTI_CONCEPT_NODE、NODE_NAME_TOO_LONG、SHORTFACT_TOO_LONG、PROBLEM_NODE_HAS_SOLUTION。
