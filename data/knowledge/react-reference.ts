...
export const referenceResearch:ResearchDocument = {
  ...
  proposal:{
    ...
    newNodes:[
      ...
      {...entry("sweep-linearity","调频非线性","chirp","实际瞬时频率相对理想线性斜坡的偏差。","非线性使去斜信号不再是理想定频正弦，可造成谱展宽和测距偏差。","需区分确定性斜坡误差与随机相位噪声。","不同采样起点、温度和距离可能暴露不同误差，校准不能只验证单点。","用参考目标或频率测量检查残差随时间和距离的变化。"),nodeType:"problem"},
